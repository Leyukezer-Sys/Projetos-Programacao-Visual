...
namespace ExemplosGrids.Formularios
{
    public partial class FormPerdido : Form
    {
        ...
        private void txtQuant_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (!char.IsNumber(e.KeyChar) && !char.IsDigit(e.KeyChar) && e.KeyChar != (char)8 && txtQuant.Text.IndexOf(',') == -1)
            {
                e.Handled = true;
            }
        }
        ...
        private void txtValorUnit_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (!char.IsNumber(e.KeyChar) && !char.IsDigit(e.KeyChar) && e.KeyChar != (char)8 && txtValorUnit.Text.IndexOf(',') != -1)
            {
                e.Handled = true;
            }
        }
